...
contract POOL {
    IToken public CREST = IToken(0xb4aE1DfeEf9224F89D48AFBcf9fA49f08DF90f26); // CREST
    IToken public BUSD = IToken(0x55d398326f99059fF775485246999027B3197955); // BUSD
    address BNB = address(0); //for BNB
    ...
    constructor() {
        Admin = payable(0x2721934Acb67c7254579F1f515951fB2FdcE95B5);
        multisigAdmin[0x2721934Acb67c7254579F1f515951fB2FdcE95B5] = true;
    ...
    function initiateTransaction(
        ...
        require(token != address(0xdead), "POOL: Invalid token address");
        ...
        isNOTBot
    {
        ...
        if (transaction.Token == BNB && transaction.isApproved) {
            ...
            if (
                ...
                transaction.amount && transaction.isApproved
            ) {
